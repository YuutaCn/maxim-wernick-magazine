...
const paths = {
  ...
  buildPartialsFolder: `${buildFolder}/partials`,
...
const htmlPartials = () => {
  return src([`${paths.srcPartialsFolder}/**/**`])
    .pipe(dest(paths.buildPartialsFolder))
    .pipe(browserSync.stream());
}
...
exports.default = series(clean, htmlInclude, htmlPartials, scripts, styles, resources, images, svgSprites, watchFiles);

exports.backend = series(clean, htmlInclude, htmlPartials, scripts, styles, resources, images, svgSprites)

exports.build = series(toProd, htmlInclude, htmlPartials, scripts, styles, resources, images, svgSprites);
